...
//    SQLiteDatabase myDataBase2;
    ...
    public void Button4Function(View view){
        if(flag) {
            ...
            imagee.animate().translationYBy(800f).setDuration(1500);
            button.animate().translationXBy(1500f).setDuration(500);
            button2.animate().translationXBy(1500f).setDuration(1000);
            button3.animate().translationXBy(1500f).setDuration(1500);
